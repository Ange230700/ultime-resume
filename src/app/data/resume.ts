...
const resumeData: ResumeData = {
  ...
  pitch:
    `I discovered programming in high school and confirmed my interest for the web development through bootcamp and courses during the time I spent in France, where I studied Full-Stack web development. I’ve gained experience with React, Node.js, and other technologies within the TypeScript/JavaScript ecosystem. And I just want to learn more and ultimately get a degree, doing all that while improving my english in the process.`.trim(),
